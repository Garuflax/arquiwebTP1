...
\begin{frame}
    ...
    \begin{itemize}\setlength\itemsep{1em}
     ...
     \item[-] Frameworks utilizados con sus principales ventajas y desventajas
     \item[-] Otras tecnologías con sus motivos de estar
%     \item[-] Que temas de diseño y arquitectura resuelve y cuáles no. Que patrones implementa. Cómo se utiliza, que conceptos introduce.
     \item[-] Organización de los componentes y módulos creados
     \item[-] Demo en vivo
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}\setlength\itemsep{1em}
     \item En alta y baja de enfermedad no se informa la fecha
...
\begin{frame}
    \frametitle{Entidades de la Base de Datos}
