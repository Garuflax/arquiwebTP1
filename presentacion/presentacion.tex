...
\begin{frame}
    ...
    \begin{itemize}\setlength\itemsep{1em}
     ...
     \item Solo se puede informar contagio fuera de la locación
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    Ventajas:
    \begin{itemize}
    \item Microframework (no toma decisiones de diseño)
...
\begin{frame}
    ...
    \item Organizado en módulos. No fuerza el uso pero lo facilita
    \item Angular Cli
    \item Event system (implementa el patrón Observer)
    \end{itemize}
...
\begin{frame}
    \frametitle{Diagrama Entidad Relación}
...
\begin{frame}
    ...
    \end{center}
    \begin{itemize}
    \item Desarrollado por Google (sin fricción)
    \item Fácil de usar
...
\begin{frame}
    ...
    \begin{itemize}
    \item Al hacer el \textbf{build} de producción de la aplicación el código QR dejó de funcionar
